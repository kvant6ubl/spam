...
void printHelp()
{
	...
	cout << "	Steganalysis by Subtractive Pixel Adjacency Matrix, T. Pevny, P. Bas, J. Fridrich, ACM Workshop of Multimedia and Digital Security, 2009, Princeton, NJ, USA" << endl
		 << endl;
	cout << "usage: spam inputDir [-T1] [-T2] [--oFile1st] [--oFile2nd]" << endl
		 << endl;
	cout << "	-T1 --- specify upper bound on absolute value of differences on 1st order SPAM features [default=4]" << endl;
	cout << "	-T2 --- specify upper bound on absolute value of differences on 2nd order SPAM features [default=3]" << endl
		 << endl;
